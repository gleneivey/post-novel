...
eye-to-eye, but I wanted to get as close as possible."
...
your city, each with a different mix of cultural components.  We have
selected two people from each to travel with us.  Youse are free to
interact with each other as much or as little as you like, though we
believe that youse will choose to accompany us on several outings from
the ship to experience different abshuman societies.  We hope to learn,
from observing youse through this, which of youse, if any, are actually
human, and whether yourse societies are stable and unlikely to imperil
yourse surroundings."
...
that yourse city of Haran, Japhet's of Ahn'tal, and the others'
...
violence between the claves issued from humanity, in part due to a set
of agreements on acceptable actions by members.  One term of these
...
obtained for those from one or more of yourse cities and their progeny.
Our journey together is a step intended to secure an extension."

Terror silenced Jacob.  E was trying to focus on Trace and read eir
expression when Japhet made a single loud, strangled laugh.  If e'd
heard it anywhere else, E would have guessed it was a dog's bark.  E'a
took eir'a full glass from the tray, drained it, and stood.  "Well
then," E'a said, "I hope that being petty and escapist are
sufficiently humuan."

Len began to rise as well E'a turned away from them, and walked stiffly toward the gap in the
floor and lift pads.  When E'a reached them, E'a threw his empty glass
at the others, but it went high and sailed over their heads between
Hunt and Regina.  Eir'a shoulders slumped, and E'a stepped onto a pad
and sank out of sight.

Jacob's attentioned returned to the table.  Trace was unmoving and
stoic; 
